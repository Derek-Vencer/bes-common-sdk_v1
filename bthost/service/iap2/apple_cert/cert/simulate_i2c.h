...
#if 0
#define BOARD_IOMUX_GPIO_I2C_SCL            HAL_IOMUX_PIN_P5_4
#define BOARD_IOMUX_GPIO_I2C_SDA            HAL_IOMUX_PIN_P5_5
#define BOARD_GPIO_GPIO_I2C_SCL             HAL_GPIO_PIN_P5_4
#define BOARD_GPIO_GPIO_I2C_SDA             HAL_GPIO_PIN_P5_5
#else
#define BOARD_IOMUX_GPIO_I2C_SCL            HAL_IOMUX_PIN_P0_0
#define BOARD_IOMUX_GPIO_I2C_SDA            HAL_IOMUX_PIN_P0_1
#define BOARD_GPIO_GPIO_I2C_SCL             HAL_GPIO_PIN_P0_0
#define BOARD_GPIO_GPIO_I2C_SDA             HAL_GPIO_PIN_P0_1
#endif
