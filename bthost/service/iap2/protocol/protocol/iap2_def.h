#ifndef __IAP2_DEF_H__
#define __IAP2_DEF_H__
...
#define IAP2_MAX_OUTSTANDING                5   // magic number
#define IAP2_ZERO_ACK_RE_TX_TIMEOUT         0   // magic number
#define IAP2_ZERO_ACK_CUM_ACK_TIMEOUT       0   // magic number
#define IAP2_ZERO_ACK_MAX_RETRANSMISSIONS   0   // magic number
...
#define IAP2_FILE_TRANSFER_SESSION_ID           0xC
