...
CHIPID="best1503"
BES_LIB_DIR="lib/bes/best1503/PRO_0001"
COMMAND=$1
set -e
...
build_app_cmd="make T=$TARGET_LIST BES_LIB_DIR=$BES_LIB_DIR $APP_CUSTOMER_CFG $BLE_CFG $OTA_CFG $TWS_CFG $SPEECH_2MIC_CFG $DECODE_DECODER_CFG $CP_CFG $SYS_CFG -j64"
