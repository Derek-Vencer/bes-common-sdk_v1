...
BUILD_CUSTOMER_CFG="BES_OTA=1 OTA_BIN_COMPRESSED=1 BLE=1 SPEECH_TX_POST_GAIN=1 SPEECH_TX_2MIC_NS8=1 SPEECH_TX_EQ=1\
                    CTKD_ENABLE=1 FLASH_SIZE=0x400000 DUAL_MIC_RECORDING=1 RECORDING_USE_OPUS=1 SING_DEVICE_REC=1 RAMCP_SIZE=0x28000 \
                    POWER_ON_ENTER_TWS_PAIRING_ENABLED=0 APP_TRACE_RX_ENABLE=1 APP_RX_API_ENABLE=1\
                    BES_LIB_DIR=lib/bes/best1306p/PRO_0009 CHIP_HAS_SPI=1 FREE_TWS_PAIRING_ENABLED=1 CAPSENSOR_ENABLE=1\
