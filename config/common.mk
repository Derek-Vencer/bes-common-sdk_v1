...
ifeq ($(USB_COMM),1)
KBUILD_CPPFLAGS += -D__USB_COMM__
endif

ifeq ($(USB_CDC_DOWNLOAD),1)
KBUILD_CPPFLAGS += -DUSB_CDC_DOWNLOAD
endif
...
export INBAND_RINGTONE_PREEMPTION_ENABLED ?= 0
ifeq ($(INBAND_RINGTONE_PREEMPTION_ENABLED),1)
KBUILD_CPPFLAGS += -DINBAND_RINGTONE_PREEMPTION_ENABLED
endif
...
export BT_VND_DIR_PATH = bthost/bt_vendor
...
export TWS_SINGLE_EAR_PLAY_LRMERGE ?= 0
ifeq ($(TWS_SINGLE_EAR_PLAY_LRMERGE),1)
KBUILD_CPPFLAGS += -DTWS_SINGLE_EAR_PLAY_LRMERGE
endif

export BQB_PTS_TEST ?=0
ifeq ($(BQB_PTS_TEST),1)
KBUILD_CPPFLAGS += -DBQB_PTS_TEST
endif
...
export AUDIO_ALGORITHMS_INCLUDES = \
    ...
    -Imultimedia/inc/audio/process/iir/include \
    ...
    -Imultimedia/inc/audio/process/dynamic_eq/include \
    -Imultimedia/inc/audio/process/dynamic_boost/include \
    -Imultimedia/inc/audio/process/common/include \
    -Imultimedia/inc/audio/process/resample/coef/include \
    -Imultimedia/inc/audio/process/bes_fir_filter/inc \
    -Imultimedia/inc/audio/process/audio_down_mixer \
    -Imultimedia/inc/audio/process/fir2iir/include \
    -Imultimedia/inc/audio/process/adaptive_volume/inc \
...
export HUOSHAN_ENABLE ?= 0
ifeq ($(HUOSHAN_ENABLE),1)
KBUILD_CPPFLAGS += -DHUOSHAN_ENABLED
export SMART_VOICE := 1
HUOSHAN_INFO_SECTION_SIZE ?= 0x1000
endif
...
export BECO ?= 1
export SPEECH_NS_BECO ?= 1
export SPEECH_NS11L ?= 0
ifeq ($(SPEECH_NS11L),1)
KBUILD_CPPFLAGS += -DSPEECH_NS11L
endif
export SPEECH_NS11S ?= 0
ifeq ($(SPEECH_NS11S),1)
KBUILD_CPPFLAGS += -DSPEECH_NS11S
endif
export LIBM_ALL_IN_RAM := 1
export SPEECH_TX_AEC_CODEC_REF := 1
...
ifeq ($(SPEECH_TX_2MIC_NS11),1)
export SPEECH_TX_2MIC_NS11
KBUILD_CPPFLAGS += -DSPEECH_TX_2MIC_NS11
KBUILD_CPPFLAGS += -DHFP_DISABLE_NREC
export SPEECH_CODEC_CAPTURE_CHANNEL_NUM = 2
export NN_LIB ?= 1
export DSP_LIB ?= 1
...
VALID_FLASH_CHIP_LIST := ALL SIMU \
	...
	P25Q256L PY25Q256LC P25Q128L P25Q64L P25Q32L P25Q32SN P25Q16L \
	P25Q32SL P25Q16SL \
...
export LDS_SECTION_FLAGS := \
    ...
    -DHUOSHAN_INFO_SECTION_SIZE=$(HUOSHAN_INFO_SECTION_SIZE)
