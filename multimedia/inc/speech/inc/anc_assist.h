...
AncAssistRes anc_assist_process(AncAssistState *st, float **ff_mic, uint8_t ff_ch_num, float **fb_mic, uint8_t fb_ch_num, float **talk_mic, uint8_t talk_ch_num, float **ref, uint8_t ref_ch_num, float *vpu_mic, uint32_t frame_len);
